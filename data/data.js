const locations = [
  ...
  { value: 'PRO', label: 'Programmatic' },
  { value: 'PR', label: 'Puerto Rico' },
  { value: 'RI', label: 'Rhode Island' },
  { value: 'SC', label: 'South Carolina' },
  { value: 'SD', label: 'South Dakota' },
  { value: 'TN', label: 'Tennessee' },
  { value: 'TT', label: 'Trust Territory of the Pacific Islands' },
...
const agencies = [
  ...
  { value: 'APHIS', label: 'Animal and Plant Health Inspection Service (APHIS)' },
  ...
  { value: 'ERDA', label: 'Energy Research and Development Administration (ERDA)' },
  ...
  { value: 'FMSHRC', label: 'Federal Mine Safety and Health Review Commission (FMSHRC)' },
  { value: 'FMCSA', label: 'Federal Motor Carrier Safety Administration (FMCSA)' },
  ...
  { value: 'IBWC', label: 'International Boundary and Water Commission (IBWC)' },
  ...
  { value: 'NASA', label: 'National Aeronautics and Space Administration (NASA)' },
  { value: 'NCPC', label: 'National Capital Planning Commission (NCPC)' },
  { value: 'NGA', label: 'National Geospatial-Intelligence Agency (NGA)' },
  { value: 'NHTSA', label: 'National Highway Traffic Safety Administration (NHTSA)' },
  ...
  { value: 'NJDEP', label: 'New Jersey Department of Environmental Protection (NJDEP)' },
  { value: 'NRC', label: 'Nuclear Regulatory Commission (NRC)' },
  { value: 'OCR', label: 'Office of Coal Research (OCR)' },
  { value: 'OSM', label: 'Office of Surface Mining (OSM)' },
...
export {
  counties,locations,agencies, draftTypeLabelsLower,decisionOptions,proximityOptions,actionOptions
}