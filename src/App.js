...
class Searcher extends React.Component {
	...
	onKeyUp = (evt) => {
		...
		// also need to wrap it in searcherInputs, or rename everything with prepending "searcherInputs."
		this.setState( // TODO: this is broken, overwrites searcherInputs with one variable
		{ 
...
function dateHelper() {
	...
	let classDates = document.getElementsByClassName("date");
	for (i = 0; i < classDates.length; i++) {
		classDates[i].setAttribute('max', today);
		classDates[i].setAttribute('value', '1970-01-01');
	}
	
	let endDates = document.getElementsByClassName("endDate");
