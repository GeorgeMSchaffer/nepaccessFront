...
class Search extends React.Component {
    ...
    render () {
        ...
        // original data has some abbreviation-only entries.  Original list from EPA also
        // does not include these.  Could find full names and add them all manually:
        // ,{ value: 'AFS', label: 'AFS' },{ value: 'ARD', label: 'ARD' },{ value: 'BOEMRE', label: 'BOEMRE' }
        //     ,{ value: 'BOR', label: 'BOR' },{ value: 'CGD', label: 'CGD' },{ value: 'COE', label: 'COE' }
        //     ,{ value: 'FHW', label: 'FHW' },{ value: 'FWS', label: 'FWS' },{ value: 'NGB', label: 'NGB' }
        //     ,{ value: 'NIG', label: 'NIG' },{ value: 'NNS', label: 'NNS' },{ value: 'UCG', label: 'UCG' }
        //     ,{ value: 'URC', label: 'URC' },{ value: 'WAP', label: 'WAP' }
