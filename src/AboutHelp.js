            ...
            <div>
                ...
                <div id="about-nepa-content">
                    ...
                    <span className="about-nepa-bold">
                        You can search for terms in the title (default search), or in the body (full-text search).  Search behavior is "all-word," meaning results will only be returned if all words in the search terms are found.
                    </span>
                    <span className="about-nepa-bold">
                        ...
                        ).  The title search also supports exact phrases and wildcards.
                    </span>
                    ...
                    <span className="default-style">
                        Additionally, the source files are sometimes available for both download and full-text search.  Because the source PDFs are often split into multiple files, the available downloads are for the archives containing one or more PDFs.
                    </span>
                    <span className="default-style">
