            ...
            <div>
                ...
                <span className="about-nepa-title">
                    ...
                    <span className="default-style">
                        NEPAccess is housed at the University of Arizona and is supported by a research grant from the National Science Foundation (no. 1831551, Dr. Laura López-Hoffman, PI), with additional resources from the University of Arizona and the Morris K. Udall and Stewart L. Udall 
                    </span>
                    <span className="default-style">
                        The NEPAccess team is interdisciplinary (principally based at UArizona, with one member from the University of California, Davis) and comprises researchers from data science, natural language processing (NLP), public administration, political science, law, natural resources policy, and UX design and 
                    </span>
                    <span className="default-style">
